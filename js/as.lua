                            ...
                            while VariableIndex.TweenToMonster and task.wait() do
                                if game.PlaceId == 128336380114944 and RoomDungeons ~= RoomDungeons2 then
                                    ...
                                    if hudRoom:FindFirstChild("Room") then
                                        local infoRoom = hudRoom:FindFirstChild("Room").Text:split("/")
                                        ...
                                        if infoRoomValue ~= nil then
                                            if infoRoomValue > 1 then
                                                ...
                                                if RoomDungeon then
                                                    if RoomDungeons ~= RoomDungeon.Parent.Name then
                                                        RoomDungeons2 = RoomDungeon.Parent.Name
                                                        RoomDungeons = RoomDungeon.Parent.Name
                                ...
                                if RoomDungeons == RoomDungeons2 and game.PlaceId == 128336380114944 then
                                    local player = game.Players.LocalPlayer
